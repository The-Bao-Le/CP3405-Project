...
def main():
    ...
    # 5. Map the 3 target flagship LLMs on the OpenRouter Free Tier (No Gemini, No DeepSeek R1)
    models = {
        "ChatGPT": "openai/gpt-4o-mini",
        "Claude": "meta-llama/llama-3.1-70b-instruct", # Llama 3.1 70B as high-fidelity Claude free tier alternative
        "Qwen": "qwen/qwen-2.5-72b-instruct:free"       # Added 100% free and stable high-performance model
    }
    ...
    # 8. Assemble the executive Markdown dashboard (Adjusted to 3 models)
    comparison_table = (
