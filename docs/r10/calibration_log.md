...
## Purpose
This file records how well our team’s market prediction matched the actual weekly result.

The goal is not only to check whether the prediction was correct, but also whether our confidence level was reasonable.
